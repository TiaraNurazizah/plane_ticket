...
?>
    ...
    <h2><center>Tambah Data Pegawai<center></h2>
    <br>
    <div class="container">
    	<?php
        if(isset($_POST['submit'])){
            $koneksi->query("INSERT INTO admin(username, nama, alamat, phone, jenis_kelamin, password, level) VALUES ('$_POST[username]', '$_POST[nama]', '$_POST[alamat]', '$_POST[phone]', '$_POST[jenis_kelamin]', '$_POST[password]', '$_POST[level]')");
